...
-- Signal types
local TypeDefinitions = require(script.Parent.Components.TypeDefinitions)
...
function Signal.new<T...>(): TypeDefinitions.Signal<T...>
...
function Signal.Wrap<T...>(rbxScriptSignal: RBXScriptSignal): TypeDefinitions.Signal<T...>
	assert(
